	...
	<div class="container">
		...
		<div class="modal fade" id="add-group" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			...
			<div class="col-md-8 offset-md-4 mt-3">
				<center><h1 style="color:#ffb380;">My diaries</h1></center><br>
				<?php
				foreach ($data['show_diary'] as $myposts) { ?>
					<div class="card mb-4">
					<?php
                $post_user = $user->findUserById($myposts->post_user_id);
                $post_user_name = $post_user->user_name;
                if ($myposts->post_image != 'no image'):
            ...
            <?php endif; ?>
				<div class="card-body">
	              ...
	              <h2 class="card-title"><?php echo substr($myposts->post_title,0,18) ?></h2>
